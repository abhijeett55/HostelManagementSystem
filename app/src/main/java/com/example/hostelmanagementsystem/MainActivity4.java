...
public class MainActivity4 extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.Vieww) {
            Intent intent = new Intent(MainActivity4.this, MainActivity6.class);
            startActivity(intent);
            return true;
        } else if (item.getItemId() == R.id.Refersh) {
            recreate();
            return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Dbms obj_database = new Dbms(getApplicationContext());
        //  at.setText(""+amount);
        ...
        ed1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                d1=new DatePickerDialog(MainActivity4.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        ed2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int presentMonth=calendar.get(Calendar.MONTH);
                final  int presentYear=calendar.get(Calendar.YEAR);
                d2=new DatePickerDialog(MainActivity4.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (TODATE1.compareTo(FROMDATE1) <= 0) {
                        ...
                        Toast.makeText(MainActivity4.this, "Booking Confirmed Sucessfully.", Toast.LENGTH_SHORT).show();
